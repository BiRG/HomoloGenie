...
# 2013-03-15 written by Nathan Adams
# for Wright State University Bioinformatics Research Group

# modified 2013-03-21
# populate_intermediate.rb compiles a data structure of "results" which are
# containers of references to objects read in from a raw structure compiled
# by fetch.rb. It is designed to make straightforward parsing for
# regression analysis and sending to a graph utility. It presently uses
# Google Image Charts (deprecated) - NOT the more modern Google Charts.
# Files are downloaded and stored locally as .png's.


# TODO: add regression values (if not lines) to charts, requiring implementation
#   of a regression class, utilize new Google Charts tool, make as class
#   for greater flexibility.

# This can be split up into an actual class, as can the graphing options.
#
